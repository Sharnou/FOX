        ...
        {!editing ? (
          <>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
              ...
              <a href="/my-ads" style={{ flex: 1, padding: 12, background: '#f3f4f6', border: 'none', borderRadius: 12, cursor: 'pointer', fontSize: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', color: '#374151' }}>
                📋 إعلاناتي
              </a>
            </div>
          </>
