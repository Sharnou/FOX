...
const LABELS = {
  ar: {
    title: 'offers_title',
    asBuyer: 'offers_as_buyer',
    asSeller: 'offers_as_seller',
    pending: 'offers_pending',
    accepted: 'offers_accepted',
    rejected: 'offers_rejected',
    countered: 'offers_countered',
    accept: 'offers_accept',
    reject: 'offers_reject',
    counter: 'offers_counter',
    counterAmount: 'offers_counter_amount',
    send: 'offers_send',
    cancel: 'offers_cancel',
    noOffers: 'offers_no_offers',
    adLabel: 'offers_ad_label',
    amountLabel: 'المبلغ:',
