...
router.post('/', auth, async (req, res) => {
  try {
    ...
    const ad = await Ad.create({ userId: req.user.id, seller: req.user.id, title, description: req.body.description, city, country: req.user.country, category: 'Services', subcategory: workerType, price });
